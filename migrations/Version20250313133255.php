 ...
 */
final class Version20250313133255 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE coupon (id INT NOT NULL, code VARCHAR(255) NOT NULL, type VARCHAR(10) NOT NULL, value DOUBLE PRECISION NOT NULL, PRIMARY KEY(id))');
